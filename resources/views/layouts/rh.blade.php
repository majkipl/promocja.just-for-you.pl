...
<div id="app">
    <header class="header position-fixed container-fluid">
        <nav id="navbar" class="navbar navbar-expand-xl">
            <div class="container">
                <a class="navbar-brand" href="{{ route('home') }}" aria-label="Remington">
                    <img src="{{ asset('/images/svg/logo.svg') }}" alt="logo" width="200">
                </a>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav justify-content-between w-100">
                        <li class="nav-item"><a class="nav-link" href="{{ route('products') }}">Produkty <span>objęte promocją</span></a></li>
                        <li class="nav-item"><a class="nav-link" href="{{ route('home') }}">Nagrody <span>do wybrania</span></a></li>
                        <li class="nav-item"><a class="nav-link" href="{{ route('form.app') }}">Formularz zgłoszeniowy <span>odbierz bransoletkę lub worek</span></a></li>
                        <li class="nav-item"><a class="nav-link" href="{{ route('form.opinion') }}">Zostaw opinię <span>odbierz dostęp do Spotify/Storytell</span></a></li>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-md-4 col-lg-5 col-xl-6 align-self-start text-center text-md-start">
                    <a href="{{ route('home') }}" aria-label="Remington">
                        <img src="{{ asset('/images/svg/logo-light.svg') }}" alt="Logo" class="logo" width="200" />
                    </a>
                    <a href="https://just-for-you.pl/" target="_blank" rel="noopener noreferrer" class="my--30">www.just-for-you.pl</a>
                    <a href="https://pl.remington-europe.com/" target="_blank" rel="noopener noreferrer" class="my--30">www.remington.pl</a>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 align-self-end text-center text-sm-end text-md-center">

                </div>
                <div class="col-12 col-md-4 col-lg-4 col-xl-3 socials align-self-end">
                    <div class="row">
                        <div class="col-4 col-sm-2 col-md-4 offset-sm-3 offset-md-0 text-center text-sm-start">
                        ...
                        <div class="col-4 col-sm-2 col-md-4 text-center text-sm-end">
                        ...
                        <div class="col-12 text-center text-md-end">
                            <a href="{$smarty.const.PRIVACY_PATH}?t={$smarty.now}" target="_blank" rel="noopener noreferrer" class="text-uppercase">Polityka prywatności</a>
                        </div>
                    </div>
                </div>
            </div>
